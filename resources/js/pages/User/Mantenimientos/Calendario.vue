    ...
    <div class="space-y-6">
      ...
      <div class="flex justify-between items-center">
        <div>
          ...
          <p class="text-gray-600 mt-1">Visualiza y gestiona los mantenimientos mensuales</p>
        </div>
        <Link
      ...
      <div class="bg-white rounded-lg shadow-lg p-6">
        ...
        <div class="grid grid-cols-7 gap-2">
          <div
            ...
            class="aspect-square border border-gray-200 rounded-lg p-2 relative transition"
            :class="{
              'bg-gray-50': !dia,
          ...
          >
            <span v-if="dia" class="font-semibold text-gray-700">{{ dia }}</span>
        ...
        <div class="p-6 space-y-6">
          ...
          <div v-if="mantenimientosDia.length > 0">
            ...
            <div>
                <p class="font-semibold text-gray-800">
                 ...
                 <span v-else class="inline-block text-xs bg-purple-100 text-purple-800 px-2 py-1 rounded-full mt-1">
                  ...
                  <span
                    ...
                    :class="getEstadoColor(mantenimiento.estado)"
                  >
                ...
                <p v-if="mantenimiento.notas_tecnicas" class="text-sm text-gray-700 whitespace-pre-line bg-white p-3 rounded border border-blue-200">
                  <span class="font-medium">Notas Técnicas:</span><br>
